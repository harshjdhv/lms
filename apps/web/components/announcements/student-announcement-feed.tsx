    ...
    if (isLoading) {
        return (
            <div className="flex h-full flex-col gap-3">
                {[1, 2, 3].map((i) => (
                    <div key={i} className="border bg-background p-4 space-y-3">
    ...
    if (announcements.length === 0) {
        return (
            <motion.div
                ...
                className="flex h-full min-h-[320px] flex-col items-center justify-center border border-dashed p-6 text-center"
            >
                <div className="bg-purple-500/10 p-4 mb-4">
                ...
                <AnimatePresence>
                    {announcements.map((announcement, index) => (
                        <motion.article
                            ...
                            className="group border bg-background p-4 transition-colors hover:bg-muted/30"
                        >
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between gap-2">
                                    <Badge variant="secondary" className="text-xs font-normal rounded-none">
